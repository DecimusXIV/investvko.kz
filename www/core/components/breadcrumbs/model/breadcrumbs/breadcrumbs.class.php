...
class BreadCrumbs {
    ...
    function __construct(modX &$modx,array $config = array()) {
        ...
        $this->config = array_merge(array(
             ...
             */
            'maxDelimiter' => '...',
            'bcTplCrumbCurrent' => '<a itemprop="url" rel="[[+description]]" href="[[++site_url]]">[[+text]]</a>',
            'bcTplCrumbCurrentLink' => '<a itemprop="url" rel="[[+description]]" href="[[++base_url]][[~[[+resource]]]]">[[+text]]</a>',
            'bcTplCrumbFirst' => '[[+text]]',
            'bcTplCrumbHome' => '<a itemprop="url" rel="[[+description]]" href="[[++site_url]]">[[+text]]</a>',
            'bcTplCrumbLast' => '<a itemprop="url" rel="[[+description]]" href="[[++site_url]]">[[+text]]</a>',
            'bcTplCrumbMax' => '[[+text]]',
            'bcTplCrumbLink' => '<a itemprop="url" rel="[[+description]]" href="[[++base_url]][[~[[+resource]]]]">[[+text]]</a>',
	...
	if ($this->modx->cultureKey=='kz'){$this->config['homeCrumbTitle'] = "Бас бет";}
	else if ($this->modx->cultureKey=='en'){$this->config['homeCrumbTitle'] = "Home";}
