...
include($basePath . '/core/config/config.inc.php');
...
$modx->addPackage('modx.transport',$basePath.'/core/model/');
        ...
        foreach($foundPackages as $foundPackage) {
            if($foundPackage->name == $packageName) {
                ...
                if($success) {
                    ...
                    echo 'Could not save package<br/> '.$foundPackage->name;
                }
                break;
            }
        }
