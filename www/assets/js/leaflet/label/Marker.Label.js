...
L.Marker.include({
	...
	bindLabel: function (content, options) {
        ...
        this._labelTranslucent = options.translucent;
		...
		if (!this._label) {
            ...
            if (this._labelTranslucent){
                this._addLabelTranslucentHandlers();
            }
			this
    ...
    _addLabelTranslucentHandlers: function () {
        this
            .on('mouseover', function(){
                this._updateLabelOpacity(1);
            }, this)
    ...
    _updateLabelOpacity:function(opacity){
        if (this._label) {
            this._label.setOpacity(opacity>0 ? opacity : 0);
        }
    }
});